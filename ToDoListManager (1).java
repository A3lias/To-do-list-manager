...
public class ToDoListManager {
    ...
    // Use ASCII hyphens ("-") instead of non‑breaking hyphens to ensure that
    // user input such as 2025-08-01 can be parsed correctly. Previously the
    // pattern used a non‑standard hyphen character, which caused valid
    // inputs to be rejected as invalid dates.
